\begin{figure}[H]
	...
	\caption{Installierte Leistung an Biogas- und Biomethankapazitäten und der Nettozubau von Biomethankapazität \parencite{BWE2020}; \textit{Eigene Darstellung}}
	\label{fig:ee-cap_biogas}
	\end{center}
\end{figure}